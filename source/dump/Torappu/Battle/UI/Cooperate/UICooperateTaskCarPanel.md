...
{
	private const Int32 TOLERANT_FONT_SCALE; // 0x0
	private const String CUR_DIST; // 0x0
	private FP m_curDist; // 0x70
	private FP m_cachedCurDist; // 0x78
	private FP m_maxDist; // 0x80
	private FP m_basicDist; // 0x88
