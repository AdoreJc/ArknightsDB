...
{
	public const String SCORE_FORMAT_BOSS; // 0x0
	private const String POINT_RATIO_HP; // 0x0
	private FP m_totalCnt; // 0x70
	private FP m_basicTotalCnt; // 0x78
	private FP m_curCnt; // 0x80
	private FP m_cachedCurCnt; // 0x88
	private FP m_basicAccomplish; // 0x90
